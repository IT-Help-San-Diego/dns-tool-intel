-- +goose Up
-- Migration 002: Data Governance Events table + pre-v26.19.0 data purge
-- Applied: 2026-02-15
-- Operator: admin
-- Status: EXECUTED (one-time operational migration)
--
-- Renumbered 001 -> 002 on 2026-07-30 when the version ledger landed: 001 is now
-- 001_base_schema.sql, which creates the tables this file's purge operated on.
-- 002 was an unused slot, so no other migration number changed.
--
