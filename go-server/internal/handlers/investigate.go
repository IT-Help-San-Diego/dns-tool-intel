...
func (h *InvestigateHandler) InvestigatePage(c *gin.Context) {
        data := NewTemplateData(c, h.Config, mapKeyInvestigate)
...
func (h *InvestigateHandler) renderInvestigateError(c *gin.Context, category, msg, domain, ip string, statusCode int) {
        data := NewTemplateData(c, h.Config, mapKeyInvestigate)
        data[strShowform] = true
        data["FlashMessages"] = []FlashMessage{{Category: category, Message: msg}}
...
func (h *InvestigateHandler) Investigate(c *gin.Context) {
        ...
        resultsData := NewTemplateData(c, h.Config, mapKeyInvestigate)
        resultsData[strShowform] = false
        resultsData["ShowResults"] = true
        resultsData["Domain"] = domain
        resultsData["AsciiDomain"] = asciiDomain
        resultsData["IPAddress"] = ip
        resultsData["Results"] = results
        resultsData["IPInfo"] = ipInfoData
        resultsData["STError"] = stError
        resultsData["IPInfoError"] = ipInfoError
