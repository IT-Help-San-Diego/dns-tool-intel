...
func TestApplyDevNullHeaders(t *testing.T) {
        /* covered by TestSprint_applyDevNullHeaders and report_mode_errors_test */
        t.Skip("exercised in analysis_coverage_sprint_test.go and report_mode_errors_test.go")
}
