...
func TestWeb3ResolutionToMap_B16(t *testing.T) {
	r := Web3ResolutionResult{
		...
		AnalysisScope:      ScopeCoreDNSOnly,
	...
	if m["analysis_scope"] != "core_dns_only" {
		t.Errorf("expected analysis_scope=core_dns_only, got %v", m["analysis_scope"])
	}
...
func TestScopeCoreDNSOnly_SkipsEmailProtocols_B16(t *testing.T) {
...
func TestDefaultWeb3Resolution_B16(t *testing.T) {
	...
	if d["analysis_scope"] != "full_dns" {
		t.Errorf("expected analysis_scope=full_dns, got %v", d["analysis_scope"])
	}
