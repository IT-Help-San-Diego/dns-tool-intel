...
func TestExtractSaaSTXTFootprint_GoogleVerification(t *testing.T) {
	results := map[string]any{
		"basic_records": map[string]any{
...
func TestExtractSaaSTXTFootprint_MultipleServices(t *testing.T) {
	results := map[string]any{
		"basic_records": map[string]any{
			"TXT": []string{
...
func TestExtractSaaSTXTFootprint_Deduplication(t *testing.T) {
	results := map[string]any{
		"basic_records": map[string]any{
			"TXT": []string{
				"google-site-verification=abc",
...
func TestExtractSaaSTXTFootprint_TXTAsAnySlice(t *testing.T) {
	results := map[string]any{
		"basic_records": map[string]any{
...
func TestExtractSaaSTXTFootprint_QuotedRecords(t *testing.T) {
	results := map[string]any{
		"basic_records": map[string]any{
...
func TestExtractSaaSTXTFootprint_MessageFormat(t *testing.T) {
	results := map[string]any{
		"basic_records": map[string]any{
			"TXT": []string{
				"google-site-verification=abc",
...
func TestSaaSPatterns_NonEmpty(t *testing.T) {
	if len(saasPatterns) == 0 {
		t.Error("saasPatterns should be non-empty ")
	}
}

func TestMatchSaaSPatterns_NoMatch(t *testing.T) {
...
func TestMatchSaaSPatterns_WithMatch(t *testing.T) {
	seen := make(map[string]bool)
	var services []map[string]any
...
func TestMatchSaaSPatterns_SeenSkipped(t *testing.T) {
...
func TestExtractSaaSTXTFootprint_NonStringInAnySlice(t *testing.T) {
	results := map[string]any{
		"basic_records": map[string]any{
...
func TestExtractSaaSTXTFootprint_AllKnownPatterns(t *testing.T) {
	patternCount := len(saasPatterns)
	if patternCount < 30 {
		t.Errorf("expected at least 30 saas patterns , got %d", patternCount)
	}
}
