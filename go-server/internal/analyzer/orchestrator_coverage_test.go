...
func TestComputeSMTPResult_TLD(t *testing.T) {
        ...
        a := &Analyzer{DNS: mockDNS, SMTPProbeMode: "skip"}
        ...
        result := a.computeSMTPResult(nil, "com", true, nil, resultsMap)
...
func TestComputeSMTPResult_NonTLD(t *testing.T) {
        ...
        result := a.computeSMTPResult(nil, "example.com", false, []string{"mx.example.com"}, resultsMap)
        if result == nil {
