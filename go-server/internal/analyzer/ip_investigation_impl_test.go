...
func TestFetchNeighborhoodDomains_ReturnsNil(t *testing.T) {
...
func TestBuildNeighborhoodContext_ReturnsEmpty(t *testing.T) {
...
func TestBuildExecutiveVerdict_ReturnsEmpty(t *testing.T) {
...
func TestVerdictSeverity_ReturnsInfo(t *testing.T) {
...
func TestFindSPFTXTRecord_ReturnsEmpty(t *testing.T) {
...
func TestCheckIPInSPFRecord_ReturnsFalse(t *testing.T) {
...
func TestCheckASNForCDNDirect_ReturnsFalse(t *testing.T) {
...
func TestClassifyOverall_ReturnsUnrelated(t *testing.T) {
