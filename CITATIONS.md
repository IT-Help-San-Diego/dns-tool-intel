...
- https://datatracker.ietf.org/doc/html/rfc6962
  Pages: faq_subdomains, results
- https://datatracker.ietf.org/doc/html/rfc7208
  Pages: case_study_intelligence_dmarc, results, sources
- https://datatracker.ietf.org/doc/html/rfc7208#appendix-A
  Pages: results
- https://datatracker.ietf.org/doc/html/rfc7208#section-3.2
  Pages: confidence
- https://datatracker.ietf.org/doc/html/rfc7208#section-4
  Pages: results
...
- https://datatracker.ietf.org/doc/html/rfc7489
  Pages: case_study_intelligence_dmarc, index, results, sources
...
- https://datatracker.ietf.org/doc/html/rfc7489#section-6.6.3
  Pages: results
- https://datatracker.ietf.org/doc/html/rfc7489#section-7
  Pages: results, results_covert
- https://datatracker.ietf.org/doc/html/rfc7489#section-7.1
  Pages: results
- https://datatracker.ietf.org/doc/html/rfc7489#section-7.3
  Pages: results
- https://datatracker.ietf.org/doc/html/rfc7505
  Pages: confidence, results, sources
- https://datatracker.ietf.org/doc/html/rfc7672
  Pages: index, results
- https://datatracker.ietf.org/doc/html/rfc7672#section-1.3
  Pages: index, results
- https://datatracker.ietf.org/doc/html/rfc7672#section-3
  Pages: results
- https://datatracker.ietf.org/doc/html/rfc7672#section-3.1
  Pages: confidence
...
- https://datatracker.ietf.org/doc/html/rfc8461
  Pages: index, results
- https://datatracker.ietf.org/doc/html/rfc8461#section-10
  Pages: index, results
- https://datatracker.ietf.org/doc/html/rfc8461#section-2
  Pages: index, results
...
- https://datatracker.ietf.org/doc/html/rfc8463
  Pages: confidence
- https://datatracker.ietf.org/doc/html/rfc8499#section-2
  Pages: results
- https://datatracker.ietf.org/doc/html/rfc8624#section-3.3
  Pages: confidence
- https://datatracker.ietf.org/doc/html/rfc8659#section-4
  Pages: confidence, results
- https://datatracker.ietf.org/doc/html/rfc8659#section-4.3
  Pages: confidence
- https://datatracker.ietf.org/doc/html/rfc8659#section-4.4
  Pages: confidence
...
## NIST/Government (14 citations)

- https://apps.dtic.mil/sti/citations/tr/AD0639176
  Pages: approach, index, results_covert
  NOTE: Returns 403 to bots. Verify in browser. Zotero snapshot recommended.
- https://apps.dtic.mil/sti/tr/pdf/ADA148883.pdf
  Pages: approach, index, results_covert
  NOTE: Returns 403 to bots. Verify in browser. Zotero snapshot recommended.
...
- https://orcid.org/0009-0000-5237-9065
  Pages: _footer, manifesto, signature_raw

## Security Tools (16 citations)

- https://crt.sh
  Pages: index
- https://nmap.org
  Pages: results_covert
- https://nmap.org/
  Pages: about
...
- https://securitytrails.com/app/signup
  Pages: index, investigate, results
- https://wireshark.org
  Pages: results_covert
...
- https://www.team-cymru.com/ip-asn-mapping
  Pages: investigate, results
- https://www.torproject.org
  Pages: results_covert
- https://www.wireshark.org
  Pages: toolkit

## Security Community (16 citations)
...
- https://hak5.org/
  Pages: about
- https://payloadhub.com/blogs/payloads/mac_exfil
  Pages: about
...
- https://techcommunity.microsoft.com/blog/exchange/announcing-general-availability-of-inbound-smtp-dane-with-dnssec-for-exchange-on/4281292
  Pages: index
- https://www.moltbook.com/u/dnstoolede
  Pages: ede
- https://www.raspberrypi.org/
  Pages: about

## Project/Internal (4 citations)

- https://www.it-help.tech
  Pages: _footer, contact, index, privacy, results, security_policy, signature_raw
- https://www.it-help.tech/.well-known/security.txt
  Pages: security_policy
- https://www.it-help.tech/security-policy
  Pages: security_policy
- https://www.it-help.tech/security.txt
  Pages: security_policy
