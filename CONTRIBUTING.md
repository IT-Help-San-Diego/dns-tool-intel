...
We use [GitHub Issues](https://github.com/IT-Help-San-Diego/dns-tool-intel/issues/new/choose) with structured templates. Blank issues are disabled — please choose the appropriate template:
...
**Questions and discussions** should go to [GitHub Discussions](https://github.com/IT-Help-San-Diego/dns-tool-intel/discussions), not the issue tracker.
...
- [GitHub Security Advisory](https://github.com/IT-Help-San-Diego/dns-tool-intel/security/advisories/new)
